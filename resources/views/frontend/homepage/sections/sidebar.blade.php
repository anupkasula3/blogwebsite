<div class="space-y-8 sticky top-24">
    <div class="bg-white rounded-xl shadow p-6">
        <h3 class="text-lg font-bold mb-2 flex items-center gap-2"><i class="fas fa-envelope text-blue-500"></i>Subscribe
        ...
        <form action="{{ route('newsletter.subscribe') }}" method="POST" class="space-y-3">
            ...
            <button type="submit"
                class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700">Subscribe</button>
        </form>
    </div>
    <div class="bg-white rounded-xl shadow p-6">
        <h3 class="text-lg font-bold mb-2 flex items-center gap-2"><i class="fas fa-bolt text-yellow-500"></i>Trending
            Posts</h3>
        <ul class="space-y-3">
    ...
    <div class="bg-white rounded-xl shadow p-6">
        <h3 class="text-lg font-bold mb-2 flex items-center gap-2"><i class="fas fa-share-alt text-green-500"></i>Stay
            Connected</h3>
