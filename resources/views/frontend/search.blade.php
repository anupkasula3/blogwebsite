    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <p class="text-lg text-gray-600">
                Found <span class="font-semibold text-[#ff2953]">{{ $posts->total() }}</span> result(s) for "<span class="font-semibold">{{ $query }}</span>"
            </p>
        </div>
        ...
        <div class="text-center py-12">
            ...
            <div class="space-y-4">
                ...
                <ul class="text-sm text-gray-500 space-y-2">
                    ...
                    <li>• Browse our <a href="{{ route('categories.index') }}" class="text-[#ff2953] hover:text-[#ff2953]/80">categories</a></li>
                </ul>
            </div>
        </div>
        @endif
