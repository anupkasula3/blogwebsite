                ...
                <div class="overflow-x-auto">
                            ...
                            <tbody class="text-sm divide-y divide-gray-100">
                                @foreach ($recentPosts as $post)
                                    ...
                                    {{ $post->is_approved ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                                        ...
                                        <td class="p-2 text-right text-gray-600">{{ $post->created_at->format('M d, Y') }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-500">No posts yet. <a href="{{ route('user.posts.create') }}"
                                    class="text-purple-600 hover:text-purple-800 font-medium">Create your first post</a>
                            </p>
                        </div>
                    @endif
                </div>
