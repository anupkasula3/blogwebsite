        ...
        <form class="mt-8 space-y-6" action="{{ route('register') }}" method="POST">
            ...
            <div class="flex items-center">
                ...
                <label for="terms" class="ml-2 block text-sm text-gray-900">
                    I agree to the
                    <a href="{{ route('terms') }}" class="text-purple-600 hover:text-purple-500">Terms of Service</a>
                    and
                    <a href="{{ route('privacy') }}" class="text-purple-600 hover:text-purple-500">Privacy Policy</a>
                </label>
            </div>
            ...
            <div>
                <button type="submit"
                    ...
                    <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                        <i class="fas fa-user-plus h-5 w-5 text-purple-300 group-hover:text-purple-200"></i>
                    </span>
                    Create Account
                </button>
            </div>
