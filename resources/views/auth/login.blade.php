...
@section('title', 'Login - ' . \App\Models\Setting::get('site_name', 'MyBlogSite'))
        ...
        <div class="bg-white/90 backdrop-blur rounded-2xl shadow-xl border border-gray-100 p-8 sm:p-10">
            <div class="flex flex-col items-center text-center">
                <div class="mx-auto h-14 w-14 bg-primary rounded-xl flex items-center justify-center shadow-md">
                    <i class="fas fa-sign-in-alt text-on-primary text-xl"></i>
                </div>
            ...
            <form class="mt-8 space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="{{ route('password.request') }}" class="font-semibold text-primary hover:underline">
