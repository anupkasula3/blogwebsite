    ...
    <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a @if ($category->parent_id != 0) href="{{ route('admin.categories.index', ['parent_id' => $category->parent_id]) }}"
            @else
                href="{{ route('admin.categories.index') }}" @endif
                    ...
                    <div class="bg-blue-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="text-sm font-medium text-blue-900">{{ $category->published_posts_count ?? 0 }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-sm text-blue-700">Total Views</span>
                                <span
                                    class="text-sm font-medium text-blue-900">{{ number_format($category->total_views ?? 0) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
