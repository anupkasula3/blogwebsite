...
@section('title', 'Create Quote - Admin')
...
<div class="flex items-center gap-x-4">
    ...
    <div class="text-xl font-semibold">Add Quote</div>
</div>

<div class="bg-white rounded-lg shadow-lg text-slate-600">
        ...
        <div class="p-6 mt-3">
            <div class="flex flex-col">
                <div>
                    ...
                    <div>
                        <textarea name="quote" id="quote" rows="4" placeholder="Enter a motivational quote..." class="w-full p-3 mt-3 text-xs border border-gray-300 rounded focus:outline-none focus:ring-blue-500 focus:border-blue-500 hover:border-blue-500 @error('quote') border-red-500 @enderror">{{ old('quote') }}</textarea>
                        @error('quote')
