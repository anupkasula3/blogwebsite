                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-3">
                            ...
                            @else
                                <form method="POST" action="{{ route('admin.posts.unfeature', $post) }}"
                                    class="inline w-full">
                                    @csrf
                                    <button type="submit"
                            ...
                            <button type="button"
                                class="w-full bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors delete-post-btn">
