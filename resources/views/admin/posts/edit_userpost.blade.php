    ...
    <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('admin.userposts.index') }}" class="text-gray-600 hover:text-gray-900">
        ...
        <form action="{{ route('admin.userposts.update', $post) }}" method="POST" enctype="multipart/form-data" class="p-6"
            id="postForm">
            @csrf
            @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <select name="category_id" id="category_id" required
                            ...
                            @php
                                // Ensure we have a Collection so filter()/where() are available
                                $allCategories = collect($categories);
                                // Normalize collection in case parent_id uses null or 0 for top-level
                        ...
                        @php
                            // Prepare JS-friendly mapping of categories -> include parent names
                        ...
                        <script>
                            ...
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                if (!sel) return;
                                // initialize from old value or post's value
