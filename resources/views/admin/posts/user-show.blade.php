...
@section('content')
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex items-center space-x-4 text-sm text-gray-600">
                                    <span class="flex items-center">
                                        ...
                                        {{ $post->author_name }}
                                        <span
                                            class="ml-1 inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                            User
                                        </span>
                                    </span>
                                    <span class="flex items-center">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="text-sm font-medium text-gray-900">{{ number_format($post->views_count) }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-sm text-gray-600">Reading Time</span>
                                <span
                                    class="text-sm font-medium text-gray-900">{{ ceil(str_word_count($post->content) / 200) }}
                                    min</span>
                            </div>
                            <div class="flex justify-between">
                        ...
                        <div class="space-y-3">
                            ...
                            @else
                                <div class="bg-green-50 border border-green-200 rounded-lg p-3">
                                    ...
                                    <p class="text-green-600 text-sm mt-1">This post has been approved and can be published.
                                    </p>
                                </div>
                            @endif
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-medium text-blue-900">
                                    {{ $post->user->created_at->format('M j, Y') ?? 'N/A' }}</p>
                            </div>
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <p class="text-sm font-medium text-gray-900">
                                    {{ $post->created_at->format('M j, Y g:i A') }}</p>
                            </div>
                            @if ($post->published_at)
                                <div>
                                    <span class="text-sm text-gray-600">Published</span>
                                    <p class="text-sm font-medium text-gray-900">
                                        {{ $post->published_at->format('M j, Y g:i A') }}</p>
                                </div>
                            @endif
                            @if ($post->updated_at && $post->updated_at != $post->created_at)
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-gray-900">
                                        {{ $post->updated_at->format('M j, Y g:i A') }}</p>
                                </div>
                            @endif
                            <div>
    ...
    <div x-data="{ open: false, form: null }" x-init="document.querySelector('.delete-userpost-btn')?.addEventListener('click', (e) => {
        $data.open = true;
