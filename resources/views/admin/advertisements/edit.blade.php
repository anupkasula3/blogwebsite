...
<div class="bg-white rounded-lg shadow-sm">
    <div class="p-6 border-b border-gray-200">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-900">Edit Advertisement</h2>
    ...
    <form method="POST" action="{{ route('admin.advertisements.update', $advertisement) }}" enctype="multipart/form-data" class="p-6">
        @csrf
        @method('PUT')
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        ...
                        placeholder="Brief description">{{ old('description', $advertisement->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="url" name="link" id="link" value="{{ old('link', $advertisement->link) }}"
                ...
                <div>
                    ...
                    <select name="position" id="position"
                        ...
                        <option value="content" {{ old('position', $advertisement->position) == 'content' ? 'selected' : '' }}>Content</option>
                    </select>
                    @error('position')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="date" name="start_date" id="start_date" value="{{ old('start_date', $advertisement->start_date ? \Carbon\Carbon::parse($advertisement->start_date)->format('Y-m-d') : '') }}"
                ...
                <div>
                    ...
                    <input type="date" name="end_date" id="end_date" value="{{ old('end_date', $advertisement->end_date ? \Carbon\Carbon::parse($advertisement->end_date)->format('Y-m-d') : '') }}"
            ...
            <div class="space-y-6">
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="mb-4">
                        <img src="{{ asset('/uploads/' . $advertisement->image) }}" alt="Current advertisement image" class="oldimage w-24 object-cover rounded-lg">
                    </div>
                    @endif
