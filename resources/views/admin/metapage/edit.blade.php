...
@section('title', 'Edit Metapage - Admin')
@section('page-title', 'Edit Metapage')
...
@section('content')
    <div class="flex gap-4">
        ...
        <div class="text-xl font-bold">Edit Metapage</div>
    </div>
    <div class="bg-white rounded-lg shadow-md ">
        <form action="{{ route('admin.metapages.update', $metapage->id) }}" method="POST" class="space-y-6" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="p-6 mt-3">
                <div class="flex flex-col ">
                    <div>
                        ...
                        <div>
                            <input
                                ...
                                value="{{ old('page_name', $metapage->page_name) }}" />
                            @error('page_name')
                    ...
                    <div class="mt-3">
                        ...
                        <div>
                            <textarea name="meta_description" rows="4"
                                      class="w-full p-3 mt-3 text-xs border border-gray-300 rounded focus:outline-none focus:ring-blue-500 focus:border-blue-500 hover:border-blue-500"
                                      placeholder="Enter meta description">{{ old('meta_description', $metapage->meta_description) }}</textarea>
                    ...
                    <div class="mt-3">
                        ...
                        @if($metapage->ogimage)
                            <img class="oldimage" src="{{ asset('/uploads/' . $metapage->ogimage) }}" alt="{{ $metapage->img_alt }}" style="width: 70px;margin-bottom:2px;">
                        @endif
                    ...
                    <div class="mt-3">
                        ...
                        <div>
                            <input
                                class="w-full p-3 mt-3 text-xs border border-gray-300 rounded focus:outline-none focus:ring-blue-500 focus:border-blue-500 hover:border-blue-500"
                                name="img_alt" placeholder="Describe the image" type="text"
                                value="{{ old('img_alt', $metapage->img_alt) }}" />
                            @error('img_alt')
                            <div class="text-sm text-red-400 invalid-feedback" style="display: block;">* {{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div>
                            <input
                                class="w-full p-3 mt-3 text-xs border border-gray-300 rounded focus:outline-none focus:ring-blue-500 focus:border-blue-500 hover:border-blue-500"
                                name="keywords" placeholder="keyword1, keyword2" type="text"
                    ...
                    <div>
                        <button class="px-4 py-1 mt-3 mr-2 text-white bg-[#ff3131] rounded-md  hover:bg-[#ff3135] hover:text-white">
                            Update
                        </button>
                    </div>
                </div>
